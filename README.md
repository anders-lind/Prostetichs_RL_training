...
Read README_MyoAssist.md for an overview of the MyoAssist project.
...
## Usage
- First follow the installation for MyoAssist in the original readme "README_MyoAssist.md"
- Then to train this model use:
