...
#     if algo == 'SAC':
#         df_clean['average_reward_per_episode'] = df_clean['average_reward_per_episode'] / 64
...
#              linestyle='-', linewidth=1.5, label=algo)
...
# # Show the plot
# plt.tight_layout()
# plt.savefig('average_reward_vs_timesteps.png')
# plt.savefig('average_reward_vs_timesteps.pdf')
...
# Add labels, title, and legend
plt.title('Average Reward per Episode vs Num Timesteps')
